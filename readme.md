...
[Downloads](https://sourceforge.net/projects/deniseemu/files/) - [IssueTracker](https://sourceforge.net/p/deniseemu/tickets) - [Nightlies Windows](https://ci.appveyor.com/project/piciji/denise/history) - [Nightlies Linux | macOS](https://sourceforge.net/projects/deniseemu/files/nightlies/) - [Build info](https://github.com/piciji/denise/blob/master/buildinfo.md)
...
* C64: add [libresidfp](https://github.com/libsidplayfp/libresidfp) (by Leandro)
* C64: support for Trilogic Expert and Prophet64 was added by ClausS
* C64: add options to disable Sprite collisions
* C64: add Disk Demon speeder for 1541
* C64: USBSID-PICO library was updated by LouD
* macOS: improve UI widget positioning, fix input problems when switching between apps
* Warp: add Fast Forward with adjustable speed, Shaders are no longer suppressed during warp (can be deactivated)
* creation of blank disks, tapes, Flash, SRAM, EEPROM is now directly integrated into the corresponding UI
* repo has moved to [GitHub](https://github.com/piciji/denise)
...
* C64: Debugger/Disassembler for: 
    ...
    * stepping: CPU/SCPU instructions, VIC-II RDY/BA cycles
    * debug borders with display of DMA usage
...
* bug fixes for both emulators, as always
