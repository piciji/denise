...
// slightly modified to make it work in mingw     
...
DECLARE_INTERFACE_(IXAudio2, IUnknown)
{
    ...
    STDMETHOD_(void, SetDebugConfiguration) (THIS_ __in_opt const XAUDIO2_DEBUG_CONFIGURATION* pDebugConfiguration,
                                             __in_opt void* pReserved X2DEFAULT(NULL)) PURE;
};
...
DECLARE_INTERFACE_(IXAudio2SourceVoice, IXAudio2Voice)
{
    ...
    //
    STDMETHOD(SubmitSourceBuffer) (THIS_ const XAUDIO2_BUFFER* pBuffer, __in_opt const XAUDIO2_BUFFER_WMA* pBufferWMA X2DEFAULT(NULL)) PURE;
