...
auto M6502New::getTheme() -> DebuggerTheme {
    switch( drive->number ) {
        default:
        case 0: return DebuggerTheme::Drive8CPU;
        case 1: return DebuggerTheme::Drive9CPU;
        case 2: return DebuggerTheme::Drive10CPU;
        case 3: return DebuggerTheme::Drive11CPU;
    }
    _unreachable
}
