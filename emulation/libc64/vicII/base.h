...
struct VicIIBase {
    ...
    auto collisionsSpiteSpriteDisabled() const -> bool;
    auto disableSpriteSpriteCollisions(bool state) -> void;
    auto collisionsSpiteForegroundDisabled() const -> bool;
    auto disableSpriteForegroundCollisions(bool state) -> void;
...
protected:     
    ...
    bool disallowSpriteSpriteCollisions;
    bool disallowSpriteForegroundCollisions;
